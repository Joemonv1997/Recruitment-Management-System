...
class Aptitude(models.Model):
    Name = models.OneToOneField(candidate, on_delete=models.CASCADE)
    aptitude_marks = models.FloatField(
        default=0, validators=[MinValueValidator(0.0), MaxValueValidator(10.0)]
    )
...
class FaceToFace(models.Model):
    Name = models.OneToOneField(candidate, on_delete=models.CASCADE)
    personality_marks = models.FloatField(
        default=0, validators=[MinValueValidator(0.0), MaxValueValidator(10.0)]
    )
    ...
    logical_marks = models.FloatField(
        default=0, validators=[MinValueValidator(0.0), MaxValueValidator(10.0)]
    )
...
class MachineMark(models.Model):
    Name = models.OneToOneField(candidate, on_delete=models.CASCADE)
    logic_marks = models.FloatField(
        default=0, validators=[MinValueValidator(0.0), MaxValueValidator(10.0)]
    )
    problemsolve_marks = models.FloatField(
        default=0, validators=[MinValueValidator(0.0), MaxValueValidator(10.0)]
    )
    Finalout_marks = models.FloatField(
        default=0, validators=[MinValueValidator(0.0), MaxValueValidator(10.0)]
    )
    average_marks = models.FloatField()
    Remarks = models.TextField(max_length=100)
